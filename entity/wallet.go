...
func (wallet *Wallet) Deposit(value float64) (float64, error) {
	if value < 0 {
		return 0, entity.CustomError.Error("O valor deve ser positivo")
	}
...
func (wallet *Wallet) Withdraw(value float64) (float64, error) {
	...
	if wallet.Balance < value {
		return 0, entity.CustomError.Error("O valor a sacar deve ser maior ou igual ao valor disponivel na carteira")
	}
	wallet.Balance -= value
